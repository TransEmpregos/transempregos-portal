...
export class HomeComponent implements OnInit {
    ...
    depoimentos = [
        {"name":"Vitor Hugo Germano",
         "company":"Lambda3",
          "message": "Nós da lambda3 ficamos muito felizes ao receber em nosso time de desenvolvimento profissionais trans que agregam muito valor ao nosso ambiente de trabalho e trazem resultados bem importantes para nossos clientes. Estamos sempre em busca de pessoas com talento, não importando sua identidade de gênero e/ou orientação sexual."}, 
    ...
    parceiros = [
        ...
        {"url":"#",
         "alt": "Logo da comissão de diversidade sexual",
